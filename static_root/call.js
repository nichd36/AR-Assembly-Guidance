...
//     setInterval(() => {
//         sendRemoteFramesToYOLO(remoteStream);
//     }, 1000);  // Adjust the interval as needed
// }

// function sendRemoteFramesToYOLO(stream) {
//         const canvas = document.createElement('canvas');
//         const context = canvas.getContext('2d');
    
//         // Draw the remote stream onto the canvas
...
//                     // Handle the response from Django YOLO view if needed
//                     console.log(response);
//                 },
